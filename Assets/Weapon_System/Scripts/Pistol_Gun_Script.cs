...
public class Pistol_Gun_Script : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        else
        {
            ...
            Pistol_Reload_Script = FindObjectOfType<Pistol_Reload_Script>();
    ...
    IEnumerator Reload_Gun()
    {
        ...
        Pistol_Reload_Script.Reload_Gun();
        ...
        if (Pistol_Reload_Script.Current_Bullet_Amount_In_Clip <= 0)
        {
    ...
    public void Shoot()
    {
        ...
        if (Pistol_Reload_Script.Current_Bullet_Amount_In_Clip <= 0 && Pistol_Reload_Script.Current_Clip_Amount <= 0)
        {
            Debug.Log("NO AMMO!!!");
            Gun_Ammo_Text.text = "x 0";
            Gun_Ammo_Text.color = Color.red;
        ...
        Current_Ammo--;
        Pistol_Reload_Script.Current_Bullet_Amount_In_Clip--;
        Gun_Ammo_Text.color = Color.white;
        Gun_Ammo_Text.text = "x " + Current_Ammo.ToString();
