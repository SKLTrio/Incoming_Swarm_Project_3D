...
public class MP5_Gun_Script : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        else
        {
            ...
            MP5_Reload_Script = FindObjectOfType<MP5_Reload_Script>();
    ...
    IEnumerator Reload_Gun()
    {
        ...
        if (MP5_Reload_Script.Current_Bullet_Amount_In_Clip <= 0)
        {
    ...
    public void Shoot()
    {
        ...
        if (MP5_Reload_Script.Current_Bullet_Amount_In_Clip <= 0 && MP5_Reload_Script.Current_Clip_Amount <= 0)
        {
            Debug.Log("NO AMMO!!!");
            Gun_Ammo_Text.text = "x 0";
            Gun_Ammo_Text.color = Color.red;
        ...
        Current_Ammo--;
        MP5_Reload_Script.Current_Bullet_Amount_In_Clip--;
        Gun_Ammo_Text.color = Color.white;
        Gun_Ammo_Text.text = "x " + Current_Ammo.ToString();
    ...
    public void Zoom_In()
    {
        ...
        {
            if (Weapon_Interface_Script.Selected_Weapon == 1 && !Is_Reloading)
            {
